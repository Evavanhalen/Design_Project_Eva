...
# Save the mean track section to an Excel file
    output_folder = r"C:\Users\eefie\PycharmProjects\DesignProject\Plots_Mean_Tracks"
    output_file_path = os.path.join(output_folder, 'Mean_Track_Section.xlsx')
    mean_track_section.to_frame('Mean Value').to_excel(output_file_path, sheet_name='Mean Track Section')

    st.write(f"Mean track section saved to {output_file_path}")
